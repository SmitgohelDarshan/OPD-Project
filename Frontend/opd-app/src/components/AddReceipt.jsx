...
const AddReceipt = () => {
  ...
  const [formData, setFormData] = useState({
    ReceiptID: 0, // Auto-generated by Backend usually
    ReceiptNo: '',
    ReceiptDate: new Date().toISOString().split('T')[0], // Default to Today
    OPDID: '',
    AmountPaid: '',
    Description: '',
    UserID: 1, // Assumed logged-in User ID
    Created: new Date().toISOString(),
    Modified: new Date().toISOString(),
    PaymentModeID: '',
    ReferenceNo: '',
    ReferenceDate: '',
    // Cancellation fields are null by default for new receipts
    cancellationDateTime: null,
    CancellationByUserID: null,
    CancellationRemarks: ''
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Example: await fetch('/api/receipts', { method: 'POST', body: JSON.stringify(formData) });
      
      // Navigate back to receipt list after successful submission
