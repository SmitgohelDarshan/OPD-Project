...
const AddOPD = () => {
  ...
  const [formData, setFormData] = useState({
    OPDID: 0,
    OPDNo: '', // Usually auto-generated by backend
    OPDDateTime: new Date().toISOString().slice(0, 16), // Format for datetime-local
    PatientID: '',
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      console.log("Submitting OPD Entry:", formData);
      // API call to save OPD record
      navigate('/admin/getAllOPD');
    } catch (error) {
      console.error('Error saving OPD entry:', error);
      alert('Failed to save OPD record.');
    }
  };
            ...
            <div>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value="101">P-1001: John Doe</option>
                  <option value="102">P-1002: Sarah Smith</option>
                </select>
              </div>
            </div>
            ...
            <div className="col-span-1 lg:col-span-2">
              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value="1">Dr. Rajesh Kumar (Cardio)</option>
                  <option value="2">Dr. Anita Varma (General)</option>
                </select>
              </div>
            </div>
