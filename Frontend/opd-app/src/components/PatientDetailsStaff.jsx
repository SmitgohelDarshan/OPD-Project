        ...
        <div className="bg-white rounded-2xl border border-blue-100 shadow-sm overflow-hidden">
          <div className="bg-gradient-to-r from-blue-700 to-indigo-800 p-8 text-white flex flex-col md:flex-row justify-between items-center gap-6">
            <div className="flex items-center gap-6">
              ...
              <div>
                <h1 className="text-3xl font-bold tracking-tight">{patient.PatientName || 'N/A'}</h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-100 border-b border-gray-100">
            <QuickStat icon={<CalendarDays className="text-blue-500" />} label="Age / Gender" value={`${patient.Age || '0'} Yrs / ${patient.Gender || 'N/A'}`} />
            <QuickStat icon={<Droplets className="text-red-500" />} label="Blood Group" value={patient.BloodGroup || 'Unknown'} />
            <QuickStat icon={<Phone className="text-green-500" />} label="Mobile" value={patient.MobileNo || 'N/A'} />
            <QuickStat icon={<Clock className="text-amber-500" />} label="Reg. Date" value={new Date(patient.RegistrationDateTime).toLocaleDateString() || 'N/A'} />
          </div>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8">
                ...
                <DetailRow label="City ID" value={patient.CityID || 'Not Assigned'} />
                <DetailRow label="State ID" value={patient.StateID || 'Not Assigned'} />
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <DetailRow label="Referred By" value={patient.ReferredBy || 'Self'} highlight />
                <DetailRow label="Clinical Description" value={patient.Description || 'No description provided'} />
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
              ...
              <div className="space-y-5">
                <DetailRow icon={<Building2 size={14}/>} label="Hospital ID" value={patient.HospitalID} />
                <DetailRow icon={<UserCheck size={14}/>} label="Created By (User ID)" value={patient.UserID} />
                <DetailRow icon={<Hash size={14}/>} label="Internal Database ID" value={patient.PatientID} />
              </div>
            </div>
            ...
            <div className="bg-orange-50 border border-orange-100 p-6 rounded-2xl">
              ...
              <p className="text-orange-800 text-sm leading-relaxed italic">
                {patient.Description ? `"${patient.Description}"` : "No special medical notes or allergies flagged for this patient record."}
              </p>
            </div>
          </div>
...
export default PatientDetailsStaff;